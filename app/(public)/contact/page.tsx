...
import { VENUE_INFO, OPERATING_HOURS } from '@/lib/constants';
...
export default function ContactPage() {
  ...
  const mapSrc = `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3862.0!2d${VENUE_INFO.lng}!3d${VENUE_INFO.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTTCsDMxJzUyLjAiTiAxMjHCsDAzJzAxLjQiRQ!5e0!3m2!1sen!2sph!4v1700000000000`;
            ...
            <div className="glass rounded-2xl p-6 space-y-5">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-muted">{VENUE_INFO.address}</p>
                </div>
              </div>

              {/* Phone */}
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-neon-magenta/10 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a href={`tel:${VENUE_INFO.phone}`} className="text-sm text-text-muted hover:text-neon-blue transition-colors">
                    {VENUE_INFO.phone}
                  </a>
                </div>
              </div>
              ...
              {/* Email */}
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-xl bg-neon-gold/10 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a href={`mailto:${VENUE_INFO.email}`} className="text-sm text-text-muted hover:text-neon-blue transition-colors">
                    {VENUE_INFO.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-muted">{t('contact.weekday')}</p>
                  <p className="text-sm text-text-muted">{t('contact.weekend')}</p>
                </div>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-sm text-neon-blue hover:text-neon-blue/80 transition-colors mt-2"
              >
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      className={[
                        ...
                        'focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-bg focus:border-neon-blue/50 focus:ring-neon-blue/30',
                        'resize-none',
                      ].join(' ')}
                      rows={5}
