...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'activities.startingAt': 'Starting at',
    ...
    'contact.weekday': 'Mon - Thu: 10AM - 12MN',
    'contact.weekend': 'Fri - Sun: 10AM - 2AM',
  ...
  fil: {
    ...
    'activities.startingAt': 'Simula sa',
    'activities.rates': 'Mga Presyo',
    'activities.notes': 'Mga Tala',
    ...
    'contact.weekday': 'Lun - Huw: 10AM - 12MN',
    'contact.weekend': 'Biy - Lin: 10AM - 2AM',
